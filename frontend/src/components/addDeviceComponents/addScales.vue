<template>
  <div>
    <div class="text-h4 q-mb-md">Умные кухонные весы</div>
    ...
    <q-input
      ...
      hint="Введите максимальный допустимый измеряемый вес"
      style="width: 99%"
    />
    ...
    return {
      ...
      pushData() {
        ...
        if (
          ...
          this.$q.notify({
            message: "Введен некорректный вес!",
            color: "warning"
          });
          return;
        }
        ...
        axios
          ...
          .then(() => {
            ...
            addLogRecord({
              log_level: "info",
              message: `Добавлено устройство "Умные кухонные весы" с названием "${this.name}"`
            });
          })
          .catch(e => {
            this.$q.notify({
            ...
            addLogRecord({
              log_level: "error",
              message: `Неудачная попытка добавить устройство "Умные кухонные весы" с названием "${this.name}"`
            });
          });
      }
    };
