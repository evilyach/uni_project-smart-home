<template>
  <div>
    <div class="text-h4 q-mb-md">Умная стиральная машина</div>
  ...
  data() {
    return {
      ...
      pushData() {
        ...
        if (isNaN(this.speed) === true || this.speed < 0 || this.speed > 1600) {
          this.$q.notify({
        ...
        axios
          ...
          .then(() => {
            ...
            addLogRecord({
              log_level: "info",
              message: `Добавлено устройство "Умная стиральная машина" с названием "${this.name}"`
            });
          })
          .catch(e => {
            this.$q.notify({
            ...
            addLogRecord({
              log_level: "error",
              message: `Неудачная попытка добавить устройство "Умная стиральная машина" с названием "${this.name}"`
            });
          });
      }
    };
